...
Reference for `ck-failure-archaeology`: the dated record of failures, workarounds, and rejected designs. Search this before retrying, removing, or resurrecting anything.
