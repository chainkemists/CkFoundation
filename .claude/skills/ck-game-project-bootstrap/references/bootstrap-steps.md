# Steps 1-9 — engine through first entity

Reference for `ck-game-project-bootstrap`: the ordered bootstrap runbook — engine registration, repo skeleton, submodules and .uproject, minimal game C++, config, Script/ root and first boot, sync-skills, project CLAUDE.md, first entity on screen.
