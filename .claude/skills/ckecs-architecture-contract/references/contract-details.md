...
Reference for `ckecs-architecture-contract`: reflection boundary, typesafe handles, requests, friend-gating, signals, dependency scoping, replication. The invariants and known-weak points stay in SKILL.md.
