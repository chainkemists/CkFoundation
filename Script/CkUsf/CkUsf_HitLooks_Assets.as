...
// CkFoundation/Source/CkParticles/Cookbook/NS_Fire.md §4,
// NS_FireBall_Hit.md §4.1 and NS_Gunshot_Hit.md §4.1. A delta table states the
...
// measured characteristics of the source paints (recipes §7). Each was measured
...
// known differences in each recipe's §13 rather than guessed at. Glow_Intensity
