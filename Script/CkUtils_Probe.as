...
{
    FCk_Handle_Probe
    Add_Sphere(FCk_Handle_Transform InHandle, float32 InRadius, const FCk_Probe_Spec &in InParams, FCk_Probe_DebugInfo InDebugInfo = FCk_Probe_DebugInfo())
    {
        auto Dimensions = FCk_ShapeSphere_Dimensions(InRadius);
        auto ShapeParams = FCk_ShapeSphere_Spec(Dimensions);
    ...
    FCk_Handle_Probe
    Add_Box(FCk_Handle_Transform InHandle, FVector InHalfExtents, const FCk_Probe_Spec &in InParams, FCk_Probe_DebugInfo InDebugInfo = FCk_Probe_DebugInfo())
    {
        auto Dimensions = FCk_ShapeBox_Dimensions(InHalfExtents);
        auto ShapeParams = FCk_ShapeBox_Spec(Dimensions);
    ...
    FCk_Handle_Probe
    Add_Capsule(FCk_Handle_Transform InHandle, float32 InHalfHeight, float32 InRadius, const FCk_Probe_Spec &in InParams, FCk_Probe_DebugInfo InDebugInfo = FCk_Probe_DebugInfo())
    {
        auto Dimensions = FCk_ShapeCapsule_Dimensions(InHalfHeight, InRadius);
        auto ShapeParams = FCk_ShapeCapsule_Spec(Dimensions);
    ...
    FCk_Handle_Probe
    Add_Cylinder(FCk_Handle_Transform InHandle, float32 InHalfHeight, float32 InRadius, const FCk_Probe_Spec &in InParams, FCk_Probe_DebugInfo InDebugInfo = FCk_Probe_DebugInfo())
    {
        auto Dimensions = FCk_ShapeCylinder_Dimensions(InHalfHeight, InRadius);
        auto ShapeParams = FCk_ShapeCylinder_Spec(Dimensions);
