...
|---|---|---|---|
| CkFoundation | `feature/game-settings` | 2026-08-05, off `dev` @ `db4261365` | `908565222` (Phase 1; Phase 0 = `23adcb3e4`) |
| CkTests | `feature/game-settings-tests` | 2026-08-06, off `dev` @ `403d887` | `dcf60c1` (Phase 1 AS tests) |
...
10. **Gate flake (environmental, root-caused):** the first `--build --test` pattern run came back
