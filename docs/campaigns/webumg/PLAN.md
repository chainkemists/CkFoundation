...
| 4 | Emission (§9 P4) | DECISION 2 output form; read-only generated assets per DECISION 3 | Round-trip diff within threshold; idempotent regen | 🟡 In progress — [Plan/Gate_04_Emission.md](Plan/Gate_04_Emission.md) |
