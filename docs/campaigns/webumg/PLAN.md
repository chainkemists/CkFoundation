...
| 3 | Paint layer (§9 P3) | Pixel-diff harness (FWidgetRenderer), rounded-rect/border paint, typed gradients, shadow strategy, text styling + tolerance regime | Paint corpus at threshold; text at §8.1 tolerance | ✅ Done 2026-08-01 (per-class budgets + text tolerance ENFORCED in the harnesses, 33/33; exit calls delegated by Adam to data-grounded recommendations) — [Plan/Gate_03_Paint_Layer.md](Plan/Gate_03_Paint_Layer.md) |
| 4 | Emission (§9 P4) | DECISION 2 output form; read-only generated assets per DECISION 3 | Round-trip diff within threshold; idempotent regen | ✅ Done 2026-08-01 (pixel suite renders THROUGH the projection, scoreboard identical; idempotence at projection+package level; 931/931; Adam approved) — [Plan/Gate_04_Emission.md](Plan/Gate_04_Emission.md) |
| 5 | Ergonomics (§9 P5) | `data-ck-*` end-to-end, live-reload preview, report UI | Real project screen converted + wired | 🟡 In progress (entered 2026-08-01) — [Plan/Gate_05_Ergonomics.md](Plan/Gate_05_Ergonomics.md) |
