...
struct CKWIDGETS_API FCk_LinePlaneIntersectionResult
{
    GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct CKWIDGETS_API FCk_ScreenEdgeLocationResult
{
    GENERATED_BODY()
...
class CKWIDGETS_API UCk_Utils_Screen_UE : public UBlueprintFunctionLibrary
{
    GENERATED_BODY()
