...
class CKWIDGETS_API UCkCommonButton : public UCommonButtonBase
{
    GENERATED_BODY()
...
class CKWIDGETS_API UCkCommonButton_Primary : public UCkCommonButton
{
    GENERATED_BODY()
...
class CKWIDGETS_API UCkCommonButton_Secondary : public UCkCommonButton
{
    GENERATED_BODY()
...
class CKWIDGETS_API UCkCommonButton_Danger : public UCkCommonButton
{
    GENERATED_BODY()
...
class CKWIDGETS_API UCkCommonButton_Tab : public UCkCommonButton
{
    GENERATED_BODY()
...
class CKWIDGETS_API UCkCommonButton_Dropdown : public UCkCommonButton
{
    GENERATED_BODY()
