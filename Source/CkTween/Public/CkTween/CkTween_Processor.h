...
namespace ck
{
    ...
    public:
        ...
        // Before both request drains so the enqueued Set*/UpdateOffset requests apply this frame. A frame
        // late, FTag_Transform_Updated is already cleared and neither scene-node children nor the mesh follow.
