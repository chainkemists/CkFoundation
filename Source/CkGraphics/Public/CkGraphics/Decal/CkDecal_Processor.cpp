...
//            TimeType InDeltaT,
//            HandleType InHandle,
//            FFragment_Decal_Requests& InRequestsComp) const
//        -> void
//    {
...
//        DoHandleRequest(
//            HandleType InHandle,
//            const FCk_Request_Decal_QueryRenderedActors& InRequest)
//        -> void
//    {
...
//        switch (RenderGroup)
//        {
//            case ECk_Decal_Group::Unspecified:
//            {
...
//                break;
//            }
//            case ECk_Decal_Group::WorldStatic:
//            {
//                InHandle.View<FFragment_OwningActor_Current, FTag_Decal_Group_WorldStatic, CK_IGNORE_PENDING_KILL>().ForEach(
//                [&](EntityType InEntity, const FFragment_OwningActor_Current& InOwningActorComp)
//                {
//                    const auto Handle = MakeHandle(InEntity, InHandle);
//                    TryAddToRenderedActorsList(InOwningActorComp.Get_EntityOwningActor().Get(), Handle);
...
//                break;
//            }
//            case ECk_Decal_Group::WorldDynamic:
//            {
//                InHandle.View<FFragment_OwningActor_Current, FTag_Decal_Group_WorldDynamic, CK_IGNORE_PENDING_KILL>().ForEach(
//                [&](EntityType InEntity, const FFragment_OwningActor_Current& InOwningActorComp)
//                {
//                    const auto Handle = MakeHandle(InEntity, InHandle);
//                    TryAddToRenderedActorsList(InOwningActorComp.Get_EntityOwningActor().Get(), Handle);
...
//                break;
//            }
//            case ECk_Decal_Group::Pawn:
//            {
//                InHandle.View<FFragment_OwningActor_Current, FTag_Decal_Group_Pawn, CK_IGNORE_PENDING_KILL>().ForEach(
//                [&](EntityType InEntity, const FFragment_OwningActor_Current& InOwningActorComp)
//                {
//                    const auto Handle = MakeHandle(InEntity, InHandle);
//                    TryAddToRenderedActorsList(InOwningActorComp.Get_EntityOwningActor().Get(), Handle);
