...
struct CKSHAPES_API FCk_Handle_ShapeBox : public FCk_Handle_Shape { GENERATED_BODY() CK_GENERATED_BODY_HANDLE_DERIVED(FCk_Handle_ShapeBox, FCk_Handle_Shape); };
...
USTRUCT(BlueprintType)
struct CKSHAPES_API FCk_ShapeBox_Spec
{
    GENERATED_BODY()

public:
    CK_GENERATED_BODY(FCk_ShapeBox_Spec);
...
public:
    ...
    CK_DEFINE_CONSTRUCTORS(FCk_ShapeBox_Spec, _InitialDimensions);
};
