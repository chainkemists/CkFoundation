...
struct CKSHAPES_API FCk_Handle_ShapeCylinder : public FCk_Handle_Shape { GENERATED_BODY() CK_GENERATED_BODY_HANDLE_DERIVED(FCk_Handle_ShapeCylinder, FCk_Handle_Shape); };
