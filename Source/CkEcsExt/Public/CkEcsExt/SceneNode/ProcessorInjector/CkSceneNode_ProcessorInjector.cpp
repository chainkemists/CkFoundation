...
auto
    ...
    DoInjectProcessors(
        ...
        -> void
{
    InWorld.Add<ck::FProcessor_SceneNode_UpdateLocal_FromMeshSocket>(InWorld.Get_Registry());
    InWorld.Add<ck::FProcessor_SceneNode_UpdateLocal_FromRootComponent>(InWorld.Get_Registry());
