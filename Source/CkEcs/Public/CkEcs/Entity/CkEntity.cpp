...
FCk_Entity FCk_Entity::_Tombstone = FCk_Entity::Tombstone();
...
auto
    FCk_Entity::
    operator=(
        TombstoneType InOther) noexcept
    -> ThisType&
{
    *this = FCk_Entity{InOther};
    return *this;
