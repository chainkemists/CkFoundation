...
namespace ck
{
    ...
    namespace detail
    {
        ...
        // ---- TIgnoreInEditor traits ----

        template <typename T>
        struct TIsIgnoreInEditor : std::false_type {};
        ...
        template <typename T>
        struct TUnwrapIgnoreInEditor<ck::TIgnoreInEditor<T>> { using Type = T; };
