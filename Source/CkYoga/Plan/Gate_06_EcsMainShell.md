...
This is not Audio acceptance and does not change the 14/27 census. Tabs, filters and five other ordinary page presentations remain native, Radar/FalloffCurve still need retained adapters, and the broader production-host every-debugger teardown matrix remains open.
