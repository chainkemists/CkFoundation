...
This is not Audio acceptance and does not change the 14/27 census. Tabs and filters plus Directors, Tracks, the rest of Spatial, Events and Overlay presentation remain native, Radar still needs a retained adapter, and the broader production-host every-debugger teardown matrix remains open.
