# Current closeout status after Float Attributes inspector migration (2026-09-13)
...
| Every-debugger teardown | GOAP, Texture, AI, EQS, Input, Scheduler, Object Pooling, Style Lab, UI, Aggro, Dialog and Visual LOD shell teardown plus the thirty-six accepted inspector release paths are focused green examples; the production-host matrix remains incomplete | Open |
