# Current closeout status after Fog Of War inspector migration (2026-09-13)
...
| Every-debugger teardown | GOAP, Texture, AI, EQS, Input, Scheduler, Object Pooling, Style Lab, UI, Aggro, Dialog and Visual LOD shell teardown plus the twenty-eight accepted inspector release paths are focused green examples; the production-host matrix remains incomplete | Open |
