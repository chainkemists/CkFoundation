# Current closeout status after EQS outer-shell and Scheduler inspector migration (2026-09-12)

| Required row | Current evidence | Status |
| --- | --- | --- |
| Authored stable outer shells | GOAP, Texture, AI and EQS own stable tabs/splitters/pane composition in authored resources; shared window chrome is authored for its consumers | 4/27 complete; 8 partial; 15 without a full authored shell |
...
| Every-debugger teardown | GOAP, Texture, AI and EQS shell teardown plus Scheduler Inspector teardown are focused green examples; the production-host matrix remains incomplete | Open |
