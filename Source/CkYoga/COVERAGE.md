# Current closeout status after Resolver inspector migration (2026-09-12)
...
| Inspector migration | GOAP Inspector Gateway, Scheduler Processor Inspector, ECS Relationships, ECS Entity Info, ECS Network, ECS Path Network, ECS Tag Set, ECS Objective, ECS ISKM Renderer and ECS Resolver successful-path layouts and presentation are authored; production data/actions remain in C++ and native builders are startup fallback/capture paths only. Other debugger inspectors remain to migrate | Open; ten inspector slices complete; 39/47 registered ECS inspectors remain native |
...
| Every-debugger teardown | GOAP, Texture, AI, EQS, Input, Scheduler, Object Pooling, Style Lab, UI, Aggro, Dialog and Visual LOD shell teardown plus the ten accepted inspector release paths are focused green examples; the production-host matrix remains incomplete | Open |
