# Current closeout status after Transform inspector migration (2026-09-12)
...
| Inspector migration | GOAP Inspector Gateway, Scheduler Processor Inspector, and ECS Relationships, Entity Info, Network, Path Network, Tag Set, Objective, ISKM Renderer, Resolver, AStar, POI, Path Network Follower, Objective Owner, Entity Tag, Entity Collections, Compass, Overlap Body, Minimap, Shapes, Timer and Transform layouts are authored; production data/actions remain in C++ and native builders are startup fallback/capture paths only. Other debugger inspectors remain to migrate | Open; twenty-two inspector slices complete overall; 27/47 registered ECS inspectors remain native |
...
| Every-debugger teardown | GOAP, Texture, AI, EQS, Input, Scheduler, Object Pooling, Style Lab, UI, Aggro, Dialog and Visual LOD shell teardown plus the twenty-two accepted inspector release paths are focused green examples; the production-host matrix remains incomplete | Open |
