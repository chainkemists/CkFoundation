...
// Complete type required: the header-inline SerializeSnapshot calls FSnapshotContext::Snapshot_Handle.
...
namespace ck
{
    ...
    // Belongs in CkEntityExtensions, but that would be a circular dependency
