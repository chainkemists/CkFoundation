...
public:
    ...
    CK_DEFINE_CPP_CASTCHECKED_TYPESAFE(FCk_Handle_AnimState);

public:
    UFUNCTION(BlueprintCallable,
              Category = "Ck|BLUEPRINT_INTERNAL_USE_ONLY",
              DisplayName="[Ck][AnimState] Add Feature")
    static FCk_Handle_AnimState
    Add(
...
private:
    ...
    UFUNCTION(BlueprintPure,
        Category = "Ck|Utils|AnimState",
        DisplayName="[Ck][AnimState] Handle -> AnimState Handle",
        meta = (CompactNodeTitle = "<AsAnimState>", BlueprintAutocast))
    static FCk_Handle_AnimState
    DoCastChecked(
        FCk_Handle InHandle);
...
public:
    ...
    static void
    Request_SetAnimGoal(
        UPARAM(ref) FCk_Handle_AnimState& InHandle,
