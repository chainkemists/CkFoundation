...
| 2 | Game seam (signals + timing verification), `TryGet_LocalViewInfo` in CkCamera, full request surface, CkTests autotests + gym | 🟡 In progress — viewer discovery + dither gym ✅ (CkTests 635361ef); remaining: flip-lifecycle AS autotests |
| 3 | Debugger surface (Gen 3 overlay providers: member state + arbiter budgets) | ✅ Done (2026-08-27, CkGameplayDebugger 880c822) |
| 4 | Range render profiles (shared SKMC/GPU policy, profile buckets, hysteresis, live runtime tuners, focused coverage) | 🟡 13/13 D3D12 automated gate green (2026-08-30); rendered pixel/A-B evidence pending |
| 5 | BB adoption + parity + duplicate deletion (executes in the BusterBlock host, tracked here) | ⏳ Pending |
