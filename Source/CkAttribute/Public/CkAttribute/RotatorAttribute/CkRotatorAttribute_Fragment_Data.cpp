#include "CkRotatorAttribute_Fragment_Data.h"
...
CK_REGISTER_SNAPSHOTABLE(FCk_Fragment_RotatorAttribute_ParamsData);

// --------------------------------------------------------------------------------------------------------------------

UE_DEFINE_GAMEPLAY_TAG(TAG_Label_RotatorAttribute, TEXT("RotatorAttribute"));
