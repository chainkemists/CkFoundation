    ...
    -> FCk_Handle_FloatAttribute
{
    ...
    {
        UCk_Utils_Net_UE::TryAddReplicatedFragment<UCk_Fragment_FloatAttribute_Rep>(InAttributeOwnerEntity);
    }
    ...
    {
        if (UCk_Utils_Net_UE::Get_HasReplicatedFragment<UCk_Fragment_FloatAttribute_Rep>(InAttributeOwnerEntity))
        {
