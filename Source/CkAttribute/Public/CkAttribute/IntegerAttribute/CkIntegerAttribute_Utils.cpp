    ...
    -> FCk_Handle_IntegerAttribute
{
    ...
    {
        UCk_Utils_Net_UE::TryAddReplicatedFragment<UCk_Fragment_IntegerAttribute_Rep>(InAttributeOwnerEntity);
    }
    ...
    {
        if (UCk_Utils_Net_UE::Get_HasReplicatedFragment<UCk_Fragment_IntegerAttribute_Rep>(InAttributeOwnerEntity))
        {
            InAttributeOwnerEntity.Try_Transform<TObjectPtr<UCk_Fragment_IntegerAttribute_Rep>>(
            [&](const TObjectPtr<UCk_Fragment_IntegerAttribute_Rep>& InRepComp)
            {
