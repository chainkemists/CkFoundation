...
class CKATTRIBUTE_API UCk_Fragment_IntegerAttribute_Rep : public UCk_Ecs_ReplicatedObject_UE
{
    GENERATED_BODY()

public:
    CK_GENERATED_BODY(UCk_Fragment_IntegerAttribute_Rep);
    CK_GENERATED_BODY_FRAGMENT_REP(UCk_Fragment_IntegerAttribute_Rep);
...
private:
    ...
    TArray<FCk_Fragment_IntegerAttribute_BaseFinal> _AttributesToReplicate;
    TArray<FCk_Fragment_IntegerAttribute_BaseFinal> _AttributesToReplicate_Previous;
};
