    ...
    -> void
{
    ...
    for (auto Index = _NextPendingAddModifier; Index < _PendingAddModifiers.Num(); ++Index)
    {
        ...
        UCk_Utils_VectorAttributeModifier_UE::Add(_AssociatedEntity, Modifier.Get_ModifierName(), Modifier.Get_Params());
    }
    ...
    for (auto Index = _NextPendingRemoveModifier; Index < _PendingRemoveModifiers.Num(); ++Index)
    {
        ...
        UCk_Utils_VectorAttributeModifier_UE::Remove(_AssociatedEntity,
