    ...
    -> FCk_Handle_ByteAttribute
{
    ...
    {
        if (const auto* RepData = UCk_Utils_Net_UE::TryGetContainerFragmentData<FCk_RepData_ByteAttributes>(InAttributeOwnerEntity))
        {
...
CK_DEFINE_HAS_CAST_CONV_HANDLE_TYPESAFE(UCk_Utils_ByteAttribute_UE, FCk_Handle_ByteAttribute, ck::FFragment_ByteAttribute_Current);
