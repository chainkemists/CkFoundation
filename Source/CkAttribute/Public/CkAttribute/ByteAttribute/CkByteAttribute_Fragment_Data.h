...
CK_REGISTER_ATTRIBUTE_HANDLE_TYPE(FCk_Handle_ByteAttribute);
...
CK_REGISTER_ATTRIBUTE_MODIFIER_HANDLE_TYPE(FCk_Handle_ByteAttributeModifier);
...
private:
    UPROPERTY(EditAnywhere, BlueprintReadWrite,
              meta = (AllowPrivateAccess = true, Categories = "ByteAttribute", SaveGame))
    FGameplayTag _Name;
