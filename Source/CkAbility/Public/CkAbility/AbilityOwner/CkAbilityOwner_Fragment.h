...
namespace ck
{
    ...
    CK_DEFINE_ECS_TAG_COUNTED(FTag_AbilityOwner_RemovePendingSubAbilityOperation);

    // --------------------------------------------------------------------------------------------------------------------

    // declared already in the utils header
    //using FFragment_AbilityOwner_Params = FCk_Fragment_AbilityOwner_ParamsData;
