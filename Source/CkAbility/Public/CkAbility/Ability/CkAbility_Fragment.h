...
namespace ck
{
    ...
    CK_DEFINE_ENTITY_HOLDER(FFragment_Ability_Source, FCk_Handle);
    ...
    CK_DEFINE_SIGNAL_AND_UTILS_WITH_DELEGATE(CKABILITY_API, OnAbilityActivated, FCk_Delegate_Ability_OnActivated, FCk_Handle_Ability, FCk_Ability_Payload_OnActivate);
    CK_DEFINE_SIGNAL_AND_UTILS_WITH_DELEGATE(CKABILITY_API, OnAbilityDeactivated, FCk_Delegate_Ability_OnDeactivated, FCk_Handle_Ability);
}
