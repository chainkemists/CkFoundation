...
namespace ck
{
    ...
    CK_DEFINE_ECS_TAG(FTag_Ability_InvalidateCurrentRequestsHandled);
    ...
    struct CKABILITY_API FFragment_Ability_RequestTransferExisting_Initialize : FRequest_Base
    {
    public:
        CK_GENERATED_BODY(FFragment_Ability_RequestTransferExisting_Initialize);
    ...
    public:
        CK_DEFINE_CONSTRUCTORS(FFragment_Ability_RequestTransferExisting_Initialize, _AbilityOwner, _TransferTarget, _AbilityToTransfer);
    };
    ...
    public:
        ...
        using TransferInit = FFragment_Ability_RequestTransferExisting_Initialize;
