...
namespace ck
{
    ...
    public:
        ...
        ForEachEntity(
            TimeType InDeltaT,
            HandleType InHandle,
            const FFragment_ResolverTarget_Requests& InRequests) const -> void;
    ...
    class CKRESOLVER_API FProcessor_ResolverTarget_CancelPendingRequests : public ck_exp::TProcessor<
