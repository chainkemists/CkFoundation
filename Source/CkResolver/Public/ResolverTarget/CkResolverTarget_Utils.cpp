...
CK_DEFINE_HAS_CAST_CONV_HANDLE_TYPESAFE(UCk_Utils_ResolverTarget_UE, FCk_Handle_ResolverTarget,
...
auto
    ...
    -> FCk_Handle_ResolverTarget
{
    CK_CALLSTACK_RECORD(ck::FFragment_ResolverTarget_Requests, InResolverTarget);
