    ...
    -> void
{
    ...
    if (auto* LifetimeOwnerEnum = StaticEnum<ECk_EntityLifetime_OwnerType>();
        ck::IsValid(LifetimeOwnerEnum))
    {
        LifetimeOwnerTypeEnumPin->DefaultValue = LifetimeOwnerEnum->GetNameStringByValue(static_cast<int64>(_LifetimeOwnerType));
    }
    ...
    -> void
{
    ...
    _LifetimeOwnerType = *UCk_Utils_EditorGraph_UE::Get_Pin_EnumValue<ECk_EntityLifetime_OwnerType>(ck_k2node_entity_script::PinName_LifetimeOwnerType, ECk_EditorGraph_PinDirection::Input, *this);
