...
// Console overrides for the three Stylize effects: `ck.Usf.{HandDrawn,CelShade,ScreenDither}.{Enabled,Debug}`.
//
...
namespace ck::usf::stylize
{
    ...
    // Broadcast on every change to any of the six. The subsystems re-sync from it, which is the whole
