...
CK_DEFINE_IS_VALID_EXECUTOR_ISBASEOF_T_ARGS(TWeakPtr, ESPMode::ThreadSafe);
CK_DEFINE_IS_VALID_EXECUTOR_ISBASEOF_T_ARGS(TWeakPtr, ESPMode::NotThreadSafe);
CK_DEFINE_IS_VALID_EXECUTOR_ISBASEOF_T(TOptional);
CK_DEFINE_IS_VALID_EXECUTOR_ISBASEOF_T_ARGS(TSharedPtr, ESPMode::ThreadSafe);
CK_DEFINE_IS_VALID_EXECUTOR_ISBASEOF_T_ARGS(TSharedPtr, ESPMode::NotThreadSafe);
