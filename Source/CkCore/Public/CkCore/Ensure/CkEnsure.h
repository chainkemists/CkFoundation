...
#define CK_ENSURE_BP(InContextObject, InExpression, InString, ...)                                                                                                           \
[&]() -> bool                                                                                                                                                                \
{                                                                                                                                                                            \
    using namespace ck;                                                                                                                                                      \
                                                                                                                                                                             \
    ...
    const auto IsMessageOnly = UCk_Utils_Core_UserSettings_UE::Get_EnsureDetailsPolicy() == ECk_EnsureDetails_Policy::MessageOnly;                                           \
                                                                                                                                                                             \
    const auto& Message = ck::Format_UE(InString, ##__VA_ARGS__);                                                                                                            \
    const auto& Title = ck::Format_UE(TEXT("Ignore and Continue? Frame#[{}] PIE-ID[{}]"), GFrameCounter, UCk_Utils_EditorOnly_UE::Get_PieNetModeNamePrefix(InContextObject));\
