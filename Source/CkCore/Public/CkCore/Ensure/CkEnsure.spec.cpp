...
{
    // Weakened, every script-raised ensure is attributed to the ck::Ensure wrapper and dedups to one signature.
    ...
    // FString's operator== is case-insensitive; these pin the CaseSensitive flag on both comparisons.
