...
#include "CkVoiceChatRelay_Subsystem.generated.h"
...
UCLASS()
class CKVOICECHAT_API UCk_VoiceChatRelay_Subsystem_UE : public UCk_ActorRelay_Group_Subsystem_Base_UE
{
    GENERATED_BODY()

public:
    CK_GENERATED_BODY(UCk_VoiceChatRelay_Subsystem_UE);
