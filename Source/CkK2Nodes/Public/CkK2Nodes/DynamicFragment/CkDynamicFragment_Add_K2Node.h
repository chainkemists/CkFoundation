...
#include "CkDynamicFragment_Add_K2Node.generated.h"

// --------------------------------------------------------------------------------------------------------------------

UCLASS(MinimalAPI)
class UCkDynamicFragment_Add_K2Node : public UCk_K2Node_UFunction_Base
{
    GENERATED_BODY()

public:
    CK_GENERATED_BODY(UCkDynamicFragment_Add_K2Node);
