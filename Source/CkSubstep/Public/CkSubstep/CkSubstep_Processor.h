...
namespace ck
{
    ...
    class CKSUBSTEP_API FProcessor_Substep_Update
        : public ck_exp::TProcessor<FProcessor_Substep_Update, FCk_Handle_Substep,
            ck::TReadOnly<FFragment_Substep_Params>, ck::TReadWrite<FFragment_Substep>, FTag_Substep_Update, CK_IGNORE_PENDING_KILL>
    {
    public:
    ...
    public:
        ...
        ForEachEntity(
            ...
            FFragment_Substep& InSubstep) const -> void;
    };
