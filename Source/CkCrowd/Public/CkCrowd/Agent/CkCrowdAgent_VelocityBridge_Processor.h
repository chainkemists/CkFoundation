...
namespace ck
{
    ...
    //
    // Group: FGroup_Physics. RunAfter Steering (read its output), RunBefore Velocity_Clamp +
    // EulerIntegrator (so the clamp + integrator see the bridge's value, not last frame's).
    //
