...
namespace ck
{
    ...
    class CKCROWD_API FProcessor_CrowdAgent_DiagAvoidanceScoreTap : public TParallelProcessor<
            ...
            ck::TReadOnly<FFragment_CrowdAgent_Tunables>, ck::TReadOnly<FFragment_CrowdAgent_NeighborCache>,
    ...
    public:
        ...
        auto ForEachEntity(
            ...
            const FFragment_CrowdAgent_Tunables&,
            const FFragment_CrowdAgent_NeighborCache&,
            const FFragment_CrowdAgent_AvoidanceVolumeCache&,
