...
| `_CloseGoalStrafe` / `_CloseGoalStrafeDistanceUu` | Enabled / 60 cm | On a full final leg outside arrival and within this small distance, translation may take the goalward direction immediately while preserving speed acceleration; facing remains turn-limited. Set distance to 0 or disable to retain ordinary turn-limited translation. |
