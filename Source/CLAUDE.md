...
| CkGroundNav | Core,Ecs,EcsExt,Jolt,Label,Log,Record,Settings,Shapes,ThirdParty (grounded-navigation provider: layered ground field, merged plates, portal graph; bake math is ECS-free and world-free; all geometry via CkJolt's JPH-free surface — no direct Jolt includes; added 2026-08-31, under construction) |
