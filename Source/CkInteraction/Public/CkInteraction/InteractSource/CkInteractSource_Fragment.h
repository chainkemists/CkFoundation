...
namespace ck
{
    ...
    CK_DEFINE_RECORD_OF_ENTITIES_TRANSIENT(FFragment_RecordOfInteractSources, FCk_Handle_InteractSource);
    ...
    struct CKINTERACTION_API FFragment_InteractSource
    {
    public:
        CK_GENERATED_BODY(FFragment_InteractSource);
