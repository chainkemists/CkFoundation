    ...
    -> FCk_Handle_InteractTarget
{
    ...
    {
        auto NewEntity = UCk_Utils_EntityLifetime_UE::Request_CreateEntity(InInteractTargetOwner);
	    NewEntity.Add<ck::FFragment_InteractTarget_Params>(InParams);
	    NewEntity.Add<ck::FFragment_InteractTarget_Current>();
